...
import (
	...
	"github.com/AbacatePay/abacatepay-go-sdk/v1/billings"
	...
	"github.com/AbacatePay/abacatepay-go-sdk/v1/withdraw"
)
...
func New(cfg ClientConfig) (*Client, error) {
	...
	return &Client{
		...
		Billings:  billings.New(http),
		Withdraws: withdraw.New(http),
